 ...
 *
 */
package org.entando.entando.plugins.jptoucantoco.apsadmin;
...
public class JptoucantocoApsAdminBaseTestCase extends ApsAdminBaseTestCase {
    ...
    private static final String CUSTOM_STRUTS_PLUGIN = "change_me-jptoucantoco-struts-plugin.xml";
}
