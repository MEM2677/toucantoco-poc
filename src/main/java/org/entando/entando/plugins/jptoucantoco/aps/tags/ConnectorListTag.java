...
public class ConnectorListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(ConnectorListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = connectorManager.getConnectors();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in ConnectorListTag doStartTag", t);
		}
